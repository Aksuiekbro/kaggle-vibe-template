...
oof_svm_pca_512 = np.zeros((len(X_train), 82))
test_svm_pca_512 = np.zeros((len(X_test), 82))

oof_svm_pca_256 = np.zeros((len(X_train), 82))
test_svm_pca_256 = np.zeros((len(X_test), 82))
...
for fold, (train_idx, val_idx) in enumerate(skf.split(X_train, y_train)):
    ...
    X_te_pca512 = pca512.transform(X_te_scaled)
    ...
    X_te_pca256 = pca256.transform(X_te_scaled)
    ...
    for seed in seeds:
        ...
        fold_te += model.predict_proba(X_te_pca512) / len(seeds)
    ...
    for seed in seeds:
        ...
        fold_te += model.predict_proba(X_te_pca256) / len(seeds)
    ...
    oof_svm_pca_512[val_idx] = val_svm_p
    test_svm_pca_512 += model_svm.predict_proba(X_te_pca512) / 5.0
    acc = accuracy_score(y_va, np.argmax(val_svm_p, axis=1))
    print(f"Fold {fold} PCA-SVM (512) Accuracy: {acc:.5f} in {time.time() - t_start:.2f}s")
    ...
    oof_svm_pca_256[val_idx] = val_svm_p
    test_svm_pca_256 += model_svm.predict_proba(X_te_pca256) / 5.0
    acc = accuracy_score(y_va, np.argmax(val_svm_p, axis=1))
    print(f"Fold {fold} PCA-SVM (256) Accuracy: {acc:.5f} in {time.time() - t_start:.2f}s")
...
models = {
    ...
    "svm_pca_512": oof_svm_pca_512,
    "svm_pca_256": oof_svm_pca_256,
    "lgb": oof_lgb
}
...
test_probs_dict = {
    ...
    "svm_pca_512": test_svm_pca_512,
    "svm_pca_256": test_svm_pca_256,
    "lgb": test_lgb
}
...
np.save(os.path.join(cache_dir, "oof_probs_pca_mlp_512_256_grid_only_v2.npy"), oof_pca_mlp_512_256)
np.save(os.path.join(cache_dir, "test_probs_pca_mlp_512_256_grid_only_v2.npy"), test_pca_mlp_512_256)
np.save(os.path.join(cache_dir, "oof_probs_pca_mlp_256_256_128_grid_only_v2.npy"), oof_pca_mlp_256_256_128)
np.save(os.path.join(cache_dir, "test_probs_pca_mlp_256_256_128_grid_only_v2.npy"), test_pca_mlp_256_256_128)
np.save(os.path.join(cache_dir, "oof_probs_raw_mlp_512_256_grid_only_v2.npy"), oof_raw_mlp_512_256)
np.save(os.path.join(cache_dir, "test_probs_raw_mlp_512_256_grid_only_v2.npy"), test_raw_mlp_512_256)
np.save(os.path.join(cache_dir, "oof_probs_raw_mlp_512_256_128_grid_only_v2.npy"), oof_raw_mlp_512_256_128)
np.save(os.path.join(cache_dir, "test_probs_raw_mlp_512_256_128_grid_only_v2.npy"), test_raw_mlp_512_256_128)
np.save(os.path.join(cache_dir, "oof_probs_svm_pca_512_grid_only_v2.npy"), oof_svm_pca_512)
np.save(os.path.join(cache_dir, "test_probs_svm_pca_512_grid_only_v2.npy"), test_svm_pca_512)
np.save(os.path.join(cache_dir, "oof_probs_svm_pca_256_grid_only_v2.npy"), oof_svm_pca_256)
np.save(os.path.join(cache_dir, "test_probs_svm_pca_256_grid_only_v2.npy"), test_svm_pca_256)
np.save(os.path.join(cache_dir, "oof_probs_lgb_grid_only_v2.npy"), oof_lgb)
np.save(os.path.join(cache_dir, "test_probs_lgb_grid_only_v2.npy"), test_lgb)

# Save final submission
os.makedirs("agents/gemini/submissions", exist_ok=True)
sub_path = "agents/gemini/submissions/submission_grid_only_v2.csv"
...
print(f"\nSaved robust grid-only ensemble v2 submission to {sub_path}")
...
results_path = os.path.join(cache_dir, "results_grid_only_v2.json")
