...
params_base = {
    ...
    'activation': 'relu',
    'solver': 'adam',
    'alpha': 0.02, # Slightly higher L2 regularization for 1490 features
    'batch_size': 128,
...
np.save(os.path.join(cache_dir, "oof_probs_ms_mlp_enhanced_grid.npy"), oof_probs_ms)
np.save(os.path.join(cache_dir, "test_probs_ms_mlp_enhanced_grid.npy"), test_probs_ms)
...
np.save(os.path.join(cache_dir, "oof_probs_lgb_enhanced_grid.npy"), oof_probs_lgb)
np.save(os.path.join(cache_dir, "test_probs_lgb_enhanced_grid.npy"), test_probs_lgb)
...
# Save submission
sub_path = "agents/gemini/submissions/submission_ensemble_enhanced_grid.csv"
...
with open(os.path.join(cache_dir, "results_ensemble_enhanced_grid.json"), "w") as f:
    json.dump(results, f, indent=2)
print("Saved ensemble results to agents/gemini/workspace/results_ensemble_enhanced_grid.json")
